...
function StudentProfileCard({ isDarkMode = false }) {
  const { avatar, fullName, studentId, className, major, hobbies, totalLikes } =
    studentProfile
  const [isOnline, setIsOnline] = useState(studentProfile.isOnline)
  ...
  return (
    <article className={cardClassName}>
      <div className="profile-card__inner">
        ...
        <section className="profile-card__section">
          <h3 className="profile-card__section-title">Current Student Status</h3>
          {isOnline ? (
            <div
